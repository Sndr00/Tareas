...
printf("Primera generación (1946-1955)\n");
printf("Se desarrollaron las primeras computadoras, estas se caracterizaban por lo siguiente:\n");
printf("\n");
printf("Válvulas de vacío: Se las usaban para realizar operaciones lógicas y de procesamiento de datos.\n");
printf("Tamaño y consumo de energía: Ocupaban habitaciones enteras y requerían un enfriamiento eficiente.\n");
printf("Programación manual: Se conectaban y configurando interruptores y conexiones.\n");
...
printf("\n");
printf("Circuitos Integrados (Chips): Permitieron combinar múltiples componentes electrónicos en un solo chip \n");
printf("Minicomputadoras: Estas máquinas eran menos costosas y más pequeñas.\n");
printf("Sistemas Operativos Avanzados: Facilitó la programación en lenguajes de alto nivel.\n");
printf("Lenguajes de Programación Avanzados: Hubo mejoras en la facilidad de uso y la eficiencia.\n");
...
printf("\n");
    ...
    printf("\n");
    printf("Inteligencia Artificial (IA): Permitiendo a las máquinas realizar tareas que anteriormente requerían la inteligencia humana.\n");
